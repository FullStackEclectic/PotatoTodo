...
class StatisticsService {
  ...
  // 获取自定义日期范围的任务统计
  static TimeRangeStats getCustomRangeStats(
    List<Task> tasks,
    DateTime startDate,
    DateTime endDate,
  ) {
  ...
  // 计算统计数据
  static TimeRangeStats _calculateStats(
    List<Task> tasks,
    DateTime startDate,
    DateTime endDate,
  ) {
  ...
  // 获取最近12个月每月的任务完成情况
  static List<MonthlyCompletionData> getLast12MonthsCompletion(
    List<Task> tasks,
  ) {

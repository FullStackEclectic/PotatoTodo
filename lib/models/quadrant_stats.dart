...
class QuadrantStats {
  ...
  // 各象限任务占比
  double get importantUrgentPercent => totalCount > 0 ? importantUrgent / totalCount * 100 : 0;
  double get importantNotUrgentPercent => totalCount > 0 ? importantNotUrgent / totalCount * 100 : 0;
  double get notImportantUrgentPercent => totalCount > 0 ? notImportantUrgent / totalCount * 100 : 0;
  double get notImportantNotUrgentPercent => totalCount > 0 ? notImportantNotUrgent / totalCount * 100 : 0;
  ...
  QuadrantStats({
    ...
    int? notImportantNotUrgentCount,
       ...
       totalCount = (importantUrgentCount ?? importantUrgent) + 
       ...
       completedCount = completedCount ?? 
                      (completedImportantUrgent + completedImportantNotUrgent + 
                       completedNotImportantUrgent + completedNotImportantNotUrgent);

...
void main() {
  ...
  group('NotificationService', () {
    ...
    test('scheduleTaskReminder handles null dueDate gracefully', () async {
      ...
      expect(
        () async => await notificationService.scheduleTaskReminder(task),
        returnsNormally,
      );
    });
    ...
    test(
      'scheduleTaskReminder cancels notification and returns normally for completed task',
      () async {
        final task = Task(
          id: 1,
    ...
    test(
      'scheduleTaskReminder cancels notification and returns normally for past dueDate',
      () async {
        final task = Task(
          id: 1,
    ...
    test('cancelNotification handles valid id', () async {
      ...
      expect(
        () async => await notificationService.cancelNotification(1),
        returnsNormally,
      );
    });
